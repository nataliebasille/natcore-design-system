        ...
        <ApiGroup label="CSS Variables">
                ...
                <span className="flex flex-col items-start gap-1.5 text-xs">
                  ...
                  {v.default && (
                    <span className="flex gap-1">
                      <span className="text-on-surface-50/60">Default: </span>
                      <span className="text-accent-500">{v.default}</span>
                    </span>
                  )}
                </span>
              </TaggedApiRow>
          ...
          {standaloneVars.map((v) => (
            ...
            >
              <span className="flex flex-col items-start gap-1.5 text-xs">
                {v.description && (
                  <span className="text-on-surface-50/80">{v.description}</span>
                )}
                {v.default && (
                  <span className="flex gap-1">
                    <span className="text-on-surface-50/60">Default: </span>
      ...
      {slots && slots.length > 0 && (
        <ApiGroup label="Slot Classes">
          {slots.map((s) => (
            ...
            >
              {s.description && (
                <span className="text-on-surface-50/80">{s.description}</span>
              )}
            </TaggedApiRow>
          ))}
        </ApiGroup>
            ...
            return (
              ...
              >
                <span className="flex flex-col gap-0.5 text-xs">
                  {v.condition && (
                    <>
                      <span className="text-on-surface-50/60">Selector: </span>
